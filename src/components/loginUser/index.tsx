...
const LoginUser = () => {
  ...
  return (
    <form
      className="w-full bg-gradient-to-br from-sky-600 to-sky-500 p-6 flex flex-col gap-6 rounded-lg"
      onSubmit={handleSubmit(onAuth)}
    >
      <h3 className="text-xl uppercase text-center text-white">
        Solicitantes e agentes de frotas.
      </h3>
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex-1 flex gap-1 items-center">
          <input
            ...
            placeholder="********"
            {...register("password")}
            className="w-full p-2 rounded outline-sky-700"
          />
          <div
