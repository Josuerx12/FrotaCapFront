...
const CollectedCard = ({ request }: { request: IMaintenceRequest }) => {
  ...
  return (
    <>
      ...
      <div
        ...
        className="w-11/12 border text-neutral-900 group mx-auto cursor-pointer hover:scale-105 hover:shadow duration-200 ease-linear bg-gray-100 rounded-lg p-2 relative before:w-full before:h-2 before:absolute before:bottom-0 before:left-0 before:bg-gray-500 before:rounded-b-md"
      >
        ...
        <p>
          <span className="font-bold capitalize">Coletado as:</span>{" "}
          {request.checkoutAt &&
            new Date(request.checkoutAt).toLocaleString("pt-BR")}
        </p>
        <p>
